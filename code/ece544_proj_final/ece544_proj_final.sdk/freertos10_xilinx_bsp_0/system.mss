...
BEGIN PROCESSOR
 ...
 PARAMETER compiler_flags =  -mlittle-endian -mxl-soft-mul -mhard-float -mxl-float-convert -mxl-float-sqrt -mcpu=v10.0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = motor_measure_control
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = motor_measure_control_0
END
