...
assign JA[0] = pmodhb3_DIR;     // DIR port on PmodHB3
assign JA[1] = pmodhb3_PWM;     // EN port on PmodHB3
assign pmodhb3_SA = JA[2];      // SA port on PmodHB3

// use JA[4] for TX and JA[5] for RX
assign esp8266_RX = JA[5];
assign JA[4] = esp8266_TX;
...
embsys EMBSYS
       (// PMOD OLED pins 
        ...
        .gpio_hb3_EN_DIR_tri_o(),                               // unused output port, use motor IP instead
        .gpio_hb3_RPM_tri_i(),                                  // unused output port, use motor IP instead
        
        // PmodHB3
        .motor_direction_out_0(pmodhb3_DIR),
        .pwm_0(pmodhb3_PWM),
        .enc_in_0(pmodhb3_SA),
        ...
        // UART pins to the ESP8266
        .uart_rtl_1_rxd(esp8266_RX),
        .uart_rtl_1_txd(esp8266_TX)
