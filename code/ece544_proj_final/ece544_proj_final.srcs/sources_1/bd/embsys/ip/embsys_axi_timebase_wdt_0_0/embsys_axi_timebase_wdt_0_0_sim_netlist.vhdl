...
-- Date        : Tue May 19 20:05:26 2020
-- Host        : Pine-Ripper running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/Projects/Code/ECE544_Proj_02/ece-544-project-2-thongd_abhiraja/code/ece544_project_02/ece544_project_02.srcs/sources_1/bd/embsys/ip/embsys_axi_timebase_wdt_0_0/embsys_axi_timebase_wdt_0_0_sim_netlist.vhdl
...
entity embsys_axi_timebase_wdt_0_0_address_decoder is
  port (
    \wdt_Bitin_1d_reg_bret__0\ : out STD_LOGIC;
    bus2ip_cs : out STD_LOGIC;
    \wdt_Bitin_1d_reg_bret__1\ : out STD_LOGIC;
    ...
    wdt_State_Reg_reg_bret : in STD_LOGIC;
    wdt_Reset_Status_Reg : in STD_LOGIC;
    \iTimebase_count_reg[4]\ : in STD_LOGIC;
    \iTimebase_count_reg[5]\ : in STD_LOGIC;
    \iTimebase_count_reg[6]\ : in STD_LOGIC;
    \iTimebase_count_reg[7]\ : in STD_LOGIC;
...
architecture STRUCTURE of embsys_axi_timebase_wdt_0_0_address_decoder is
  ...
  signal \^wdt_bitin_1d_reg_bret__0\ : STD_LOGIC;
  signal \^wdt_bitin_1d_reg_bret__1\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of eWDT2_Reg_i_1 : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \wdt_State_Reg_bret__4_i_1\ : label is "soft_lutpair2";
begin
  bus2ip_cs <= \^bus2ip_cs\;
...
\wdt_State_Reg_bret__4_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
entity embsys_axi_timebase_wdt_0_0_timebase_wdt_core is
  port (
    ...
    \iTimebase_count_reg[7]_0\ : out STD_LOGIC;
    \iTimebase_count_reg[7]_1\ : out STD_LOGIC;
    \iTimebase_count_reg[7]_2\ : out STD_LOGIC;
    \iTimebase_count_reg[7]_3\ : out STD_LOGIC;
...
architecture STRUCTURE of embsys_axi_timebase_wdt_0_0_timebase_wdt_core is
  ...
  attribute RTL_KEEP of \FSM_onehot_WDT_Current_State_reg_n_0_[0]\ : signal is "yes";
  signal \FSM_onehot_WDT_Current_State_reg_n_0_[1]\ : STD_LOGIC;
  attribute RTL_KEEP of \FSM_onehot_WDT_Current_State_reg_n_0_[1]\ : signal is "yes";
  signal \FSM_onehot_WDT_Current_State_reg_n_0_[2]\ : STD_LOGIC;
  attribute RTL_KEEP of \FSM_onehot_WDT_Current_State_reg_n_0_[2]\ : signal is "yes";
  ...
  signal \^itimebase_count_reg[7]_0\ : STD_LOGIC;
  signal \^itimebase_count_reg[7]_1\ : STD_LOGIC;
  signal \^itimebase_count_reg[7]_2\ : STD_LOGIC;
  signal \^itimebase_count_reg[7]_3\ : STD_LOGIC;
  ...
  attribute RTL_KEEP of iWDT_Reset : signal is "yes";
  ...
  signal \timer_width_reg[4]_fret__0_n_0\ : STD_LOGIC;
  signal \timer_width_reg[4]_fret__1_fret__0_n_0\ : STD_LOGIC;
  signal \timer_width_reg[4]_fret__1_fret_n_0\ : STD_LOGIC;
  signal \timer_width_reg[4]_fret__1_n_0\ : STD_LOGIC;
  signal \timer_width_reg[4]_fret__2_n_0\ : STD_LOGIC;
  signal \timer_width_reg[4]_fret_n_0\ : STD_LOGIC;
  signal wdt_Bitin_1d_bret_i_1_n_0 : STD_LOGIC;
  signal \wdt_Bitin_1d_reg_bret__0_n_0\ : STD_LOGIC;
  signal \wdt_Bitin_1d_reg_bret__1_n_0\ : STD_LOGIC;
  signal \wdt_Bitin_1d_reg_bret__2_n_0\ : STD_LOGIC;
  signal \wdt_Bitin_1d_reg_bret__3_n_0\ : STD_LOGIC;
  signal wdt_Bitin_1d_reg_bret_n_0 : STD_LOGIC;
  ...
  signal wdt_State_Preset_i_13_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_14_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_15_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_16_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_17_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_18_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_19_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_20_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_21_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_22_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_23_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_24_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_25_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_26_n_0 : STD_LOGIC;
  signal wdt_State_Preset_i_27_n_0 : STD_LOGIC;
  ...
  signal wdt_State_Preset_reg_i_10_n_0 : STD_LOGIC;
  signal wdt_State_Preset_reg_i_11_n_0 : STD_LOGIC;
  signal wdt_State_Preset_reg_i_2_n_0 : STD_LOGIC;
  signal wdt_State_Preset_reg_i_8_n_0 : STD_LOGIC;
  signal wdt_State_Preset_reg_i_9_n_0 : STD_LOGIC;
  signal \wdt_State_Reg_reg_bret__0_n_0\ : STD_LOGIC;
  signal \wdt_State_Reg_reg_bret__1_n_0\ : STD_LOGIC;
  signal \wdt_State_Reg_reg_bret__2_n_0\ : STD_LOGIC;
  signal \wdt_State_Reg_reg_bret__3_n_0\ : STD_LOGIC;
  signal \wdt_State_Reg_reg_bret__4_n_0\ : STD_LOGIC;
  signal wdt_State_Reg_reg_bret_n_0 : STD_LOGIC;
  ...
  attribute KEEP of \FSM_onehot_WDT_Current_State_reg[0]\ : label is "yes";
  ...
  attribute KEEP of \FSM_onehot_WDT_Current_State_reg[1]\ : label is "yes";
  ...
  attribute KEEP of \FSM_onehot_WDT_Current_State_reg[2]\ : label is "yes";
  ...
  attribute KEEP of \FSM_onehot_WDT_Current_State_reg[3]\ : label is "yes";
  attribute SOFT_HLUTNM : string;
...
begin
  ...
  \iTimebase_count_reg[7]_0\ <= \^itimebase_count_reg[7]_0\;
  \iTimebase_count_reg[7]_1\ <= \^itimebase_count_reg[7]_1\;
  \iTimebase_count_reg[7]_2\ <= \^itimebase_count_reg[7]_2\;
  \iTimebase_count_reg[7]_3\ <= \^itimebase_count_reg[7]_3\;
  p_0_in <= \^p_0_in\;
...
\iTimebase_count_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \^itimebase_count_reg[7]_3\,
      S(2) => \^itimebase_count_reg[7]_2\,
      S(1) => \^itimebase_count_reg[7]_1\,
      S(0) => \^itimebase_count_reg[7]_0\
    );
...
\timer_width_reg[4]_fret\: unisim.vcomponents.FDSE
     port map (
      C => s_axi_aclk,
      CE => bus2ip_wrce(0),
      D => g0_b2_n_0,
...
\timer_width_reg[4]_fret__0\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_aclk,
      CE => bus2ip_wrce(0),
      D => g0_b1_n_0,
...
\timer_width_reg[4]_fret__1\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_aclk,
      CE => bus2ip_wrce(0),
      D => g0_b0_n_0,
...
\timer_width_reg[4]_fret__1_fret\: unisim.vcomponents.FDSE
     port map (
      C => s_axi_aclk,
      CE => bus2ip_wrce(0),
      D => \g0_b0__1_n_0\,
...
\timer_width_reg[4]_fret__1_fret__0\: unisim.vcomponents.FDSE
     port map (
      C => s_axi_aclk,
      CE => bus2ip_wrce(0),
      D => \g0_b0__0_n_0\,
...
\timer_width_reg[4]_fret__2\: unisim.vcomponents.FDSE
     port map (
      C => s_axi_aclk,
      CE => bus2ip_wrce(0),
      D => g0_b3_n_0,
...
wdt_Bitin_1d_bret_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"09"
    )
        port map (
...
wdt_Bitin_1d_reg_bret: unisim.vcomponents.FDRE
     port map (
      C => s_axi_aclk,
      CE => '1',
...
\wdt_Bitin_1d_reg_bret__0\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_aclk,
      CE => '1',
...
\wdt_Bitin_1d_reg_bret__1\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_aclk,
      CE => '1',
      D => Bus_RNW_reg,
...
\wdt_Bitin_1d_reg_bret__2\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_aclk,
      CE => '1',
      D => s_axi_wdata(2),
      Q => \wdt_Bitin_1d_reg_bret__2_n_0\,
      R => '0'
    );
\wdt_Bitin_1d_reg_bret__3\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
wdt_State_Preset_i_13: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FCAF0CAFFCA00CA0"
    )
        port map (
...
wdt_State_Preset_i_14: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FCAF0CAFFCA00CA0"
    )
        port map (
...
wdt_State_Preset_i_15: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FCAF0CAFFCA00CA0"
    )
        port map (
...
wdt_State_Preset_i_16: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FCAF0CAFFCA00CA0"
    )
        port map (
...
wdt_State_Preset_i_17: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FCAF0CAFFCA00CA0"
    )
        port map (
...
wdt_State_Preset_i_18: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FCAF0CAFFCA00CA0"
    )
        port map (
...
wdt_State_Preset_i_19: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FCAF0CAFFCA00CA0"
    )
        port map (
...
wdt_State_Preset_i_20: unisim.vcomponents.LUT6
    generic map(
...
wdt_State_Preset_i_21: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
wdt_State_Preset_i_22: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
wdt_State_Preset_i_23: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
wdt_State_Preset_i_24: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
wdt_State_Preset_i_25: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
wdt_State_Preset_i_26: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
wdt_State_Preset_i_27: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
wdt_State_Preset_i_4: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \wdt_Bitin_1d_reg_bret__2_n_0\,
      I4 => \wdt_Bitin_1d_reg_bret__3_n_0\,
      I5 => \^wdt_reset\,
      O => wdt_State_Preset_i_4_n_0
    );
wdt_State_Preset_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAAA9"
    )
        port map (
...
wdt_State_Preset_reg_i_10: unisim.vcomponents.MUXF7
     port map (
...
wdt_State_Preset_reg_i_11: unisim.vcomponents.MUXF7
     port map (
...
wdt_State_Preset_reg_i_8: unisim.vcomponents.MUXF7
     port map (
...
wdt_State_Preset_reg_i_9: unisim.vcomponents.MUXF7
     port map (
...
wdt_State_Reg_reg_bret: unisim.vcomponents.FDRE
     port map (
      C => s_axi_aclk,
      CE => '1',
      D => \^wdt_interrupt\,
...
\wdt_State_Reg_reg_bret__0\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_aclk,
      CE => '1',
      D => p_2_in,
...
\wdt_State_Reg_reg_bret__1\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_aclk,
      CE => '1',
      D => wdt_State_Preset,
...
\wdt_State_Reg_reg_bret__2\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_aclk,
      CE => '1',
      D => s_axi_aresetn,
...
\wdt_State_Reg_reg_bret__3\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\wdt_State_Reg_reg_bret__4\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_aclk,
      CE => '1',
      D => bus2ip_wrce(1),
...
wdt_interrupt_INST_0: unisim.vcomponents.LUT6
    generic map(
...
I_DECODER: entity work.embsys_axi_timebase_wdt_0_0_address_decoder
     port map (
      ...
      \FSM_onehot_state_reg[3]\(2) => I_DECODER_n_7,
      \FSM_onehot_state_reg[3]\(1) => I_DECODER_n_8,
      \FSM_onehot_state_reg[3]\(0) => I_DECODER_n_9,
...
entity embsys_axi_timebase_wdt_0_0_axi_timebase_wdt_top is
  ...
  attribute C_WDT_ENABLE_ONCE of embsys_axi_timebase_wdt_0_0_axi_timebase_wdt_top : entity is 0;
  attribute C_WDT_INTERVAL : integer;
  attribute C_WDT_INTERVAL of embsys_axi_timebase_wdt_0_0_axi_timebase_wdt_top : entity is 28;
  attribute ORIG_REF_NAME : string;
...
entity embsys_axi_timebase_wdt_0_0 is
  ...
  attribute x_core_info of embsys_axi_timebase_wdt_0_0 : entity is "axi_timebase_wdt_top,Vivado 2018.2";
...
architecture STRUCTURE of embsys_axi_timebase_wdt_0_0 is
  ...
  attribute C_WDT_INTERVAL : integer;
  attribute C_WDT_INTERVAL of U0 : label is 28;
