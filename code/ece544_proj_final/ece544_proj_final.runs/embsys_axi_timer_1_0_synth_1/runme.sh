...
HD_PWD='D:/Projects/Code/ECE544_Proj_02/ece-544-project-2-thongd_abhiraja/code/ece544_project_02/ece544_project_02.runs/embsys_axi_timer_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_axi_timer_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_axi_timer_1_0.tcl
