...
HD_PWD='D:/Projects/Code/ECE544_Proj_Final/code/ece544_proj_final/ece544_proj_final.runs/embsys_axi_uartlite_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_axi_uartlite_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_axi_uartlite_1_0.tcl
